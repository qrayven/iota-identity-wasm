...
export interface InitOutput {
  ...
  readonly __wbg_jws_free: (a: number) => void;
  readonly jws_constructor: (a: number, b: number) => number;
  readonly jws_toString: (a: number, b: number) => void;
  readonly jwt_toString: (a: number, b: number) => void;
  readonly jwt_toJSON: (a: number, b: number) => void;
  readonly jwt_fromJSON: (a: number, b: number) => void;
  readonly jwt_clone: (a: number) => number;
  readonly __wbg_sdjwtcredentialvalidator_free: (a: number) => void;
  readonly sdjwtcredentialvalidator_new: (a: number) => number;
  readonly sdjwtcredentialvalidator_validateCredential: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly sdjwtcredentialvalidator_verifySignature: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly sdjwtcredentialvalidator_validateKeyBindingJwt: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly __wbg_jwk_free: (a: number) => void;
  readonly jwk_new: (a: number) => number;
  readonly jwk_kty: (a: number) => number;
  readonly jwk_use: (a: number) => number;
  readonly jwk_keyOps: (a: number) => number;
  readonly jwk_alg: (a: number) => number;
  readonly jwk_kid: (a: number, b: number) => void;
  readonly jwk_x5u: (a: number, b: number) => void;
  readonly jwk_x5c: (a: number) => number;
  readonly jwk_x5t: (a: number, b: number) => void;
  readonly jwk_x5t256: (a: number, b: number) => void;
  readonly jwk_paramsEc: (a: number, b: number) => void;
  readonly jwk_paramsOkp: (a: number, b: number) => void;
  readonly jwk_paramsOct: (a: number, b: number) => void;
  readonly jwk_paramsRsa: (a: number, b: number) => void;
  readonly jwk_toPublic: (a: number) => number;
  readonly jwk_isPublic: (a: number) => number;
  readonly jwk_isPrivate: (a: number) => number;
  readonly jwk_toJSON: (a: number, b: number) => void;
  readonly jwk_fromJSON: (a: number, b: number) => void;
  readonly jwk_clone: (a: number) => number;
  readonly __wbg_jwsheader_free: (a: number) => void;
  readonly jwsheader_new: () => number;
  readonly jwsheader_alg: (a: number) => number;
  readonly jwsheader_setAlg: (a: number, b: number, c: number) => void;
  readonly jwsheader_b64: (a: number) => number;
  readonly jwsheader_setB64: (a: number, b: number) => void;
  readonly jwsheader_custom: (a: number) => number;
  readonly jwsheader_has: (a: number, b: number, c: number) => number;
  readonly jwsheader_isDisjoint: (a: number, b: number) => number;
  readonly jwsheader_jku: (a: number, b: number) => void;
  readonly jwsheader_setJku: (a: number, b: number, c: number, d: number) => void;
  readonly jwsheader_jwk: (a: number) => number;
  readonly jwsheader_setJwk: (a: number, b: number) => void;
  readonly jwsheader_kid: (a: number, b: number) => void;
  readonly jwsheader_setKid: (a: number, b: number, c: number) => void;
  readonly jwsheader_x5u: (a: number, b: number) => void;
  readonly jwsheader_setX5u: (a: number, b: number, c: number, d: number) => void;
  readonly jwsheader_setX5c: (a: number, b: number, c: number) => void;
  readonly jwsheader_x5t: (a: number, b: number) => void;
  readonly jwsheader_setX5t: (a: number, b: number, c: number) => void;
  readonly jwsheader_x5tS256: (a: number, b: number) => void;
  readonly jwsheader_setX5tS256: (a: number, b: number, c: number) => void;
  readonly jwsheader_typ: (a: number, b: number) => void;
  readonly jwsheader_setTyp: (a: number, b: number, c: number) => void;
  readonly jwsheader_cty: (a: number, b: number) => void;
  readonly jwsheader_setCty: (a: number, b: number, c: number) => void;
  readonly jwsheader_crit: (a: number) => number;
  readonly jwsheader_setCrit: (a: number, b: number, c: number) => void;
  readonly jwsheader_url: (a: number, b: number) => void;
  readonly jwsheader_setUrl: (a: number, b: number, c: number, d: number) => void;
  readonly jwsheader_nonce: (a: number, b: number) => void;
  readonly jwsheader_setNonce: (a: number, b: number, c: number) => void;
  readonly jwsheader_toJSON: (a: number, b: number) => void;
  readonly jwsheader_fromJSON: (a: number, b: number) => void;
  ...
  readonly revocationbitmap_toService: (a: number, b: number, c: number) => void;
  readonly revocationbitmap_fromEndpoint: (a: number, b: number) => void;
  readonly __wbg_sdjwt_free: (a: number) => void;
  readonly sdjwt_new: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly sdjwt_presentation: (a: number, b: number) => void;
  readonly sdjwt_parse: (a: number, b: number, c: number) => void;
  readonly sdjwt_jwt: (a: number, b: number) => void;
  readonly sdjwt_disclosures: (a: number) => number;
  readonly sdjwt_keyBindingJwt: (a: number, b: number) => void;
  readonly sdjwt_toJSON: (a: number, b: number) => void;
  readonly sdjwt_fromJSON: (a: number, b: number) => void;
  ...
  readonly methoddata_newJwk: (a: number, b: number) => void;
  readonly methoddata_tryDecode: (a: number, b: number) => void;
  readonly methoddata_tryPublicKeyJwk: (a: number, b: number) => void;
  ...
  readonly sdjwt_toString: (a: number, b: number) => void;
  readonly __wbg_jwt_free: (a: number) => void;
  readonly jwsheader_x5c: (a: number) => number;
  readonly __wbg_decodedjwtcredential_free: (a: number) => void;
  readonly decodedjwtcredential_credential: (a: number) => number;
  readonly decodedjwtcredential_protectedHeader: (a: number) => number;
  readonly decodedjwtcredential_customClaims: (a: number) => number;
  readonly decodedjwtcredential_intoCredential: (a: number) => number;
  readonly __wbg_unknowncredential_free: (a: number) => void;
  readonly unknowncredential_tryIntoJwt: (a: number) => number;
  readonly unknowncredential_tryIntoCredential: (a: number) => number;
  readonly unknowncredential_tryIntoRaw: (a: number) => number;
  readonly unknowncredential_toJSON: (a: number, b: number) => void;
  readonly unknowncredential_fromJSON: (a: number, b: number) => void;
  readonly unknowncredential_clone: (a: number) => number;
  readonly __wbg_methoddigest_free: (a: number) => void;
  readonly methoddigest_new: (a: number, b: number) => void;
  readonly methoddigest_pack: (a: number) => number;
  readonly methoddigest_unpack: (a: number, b: number) => void;
  readonly methoddigest_clone: (a: number) => number;
  readonly __wbg_domainlinkageconfiguration_free: (a: number) => void;
  readonly domainlinkageconfiguration_new: (a: number, b: number) => void;
  readonly domainlinkageconfiguration_linkedDids: (a: number) => number;
  readonly domainlinkageconfiguration_issuers: (a: number, b: number) => void;
  readonly domainlinkageconfiguration_toJSON: (a: number, b: number) => void;
  readonly domainlinkageconfiguration_fromJSON: (a: number, b: number) => void;
  readonly domainlinkageconfiguration_clone: (a: number) => number;
  readonly __wbg_jwtdomainlinkagevalidator_free: (a: number) => void;
  readonly jwtdomainlinkagevalidator_new: (a: number) => number;
  readonly jwtdomainlinkagevalidator_validateLinkage: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly jwtdomainlinkagevalidator_validateCredential: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly __wbg_storage_free: (a: number) => void;
  readonly storage_new: (a: number, b: number) => number;
  readonly storage_keyIdStorage: (a: number) => number;
  readonly storage_keyStorage: (a: number) => number;
  readonly encodeB64: (a: number, b: number, c: number) => void;
  readonly decodeB64: (a: number, b: number, c: number) => void;
  readonly start: () => void;
  readonly __wbg_decodedjwtpresentation_free: (a: number) => void;
  ...
  readonly decodedjwtpresentation_audience: (a: number, b: number) => void;
  readonly decodedjwtpresentation_customClaims: (a: number) => number;
  ...
  readonly __wbg_jwsverificationoptions_free: (a: number) => void;
  readonly jwsverificationoptions_new: (a: number, b: number) => void;
  ...
  readonly jwsverificationoptions_toJSON: (a: number, b: number) => void;
  readonly jwsverificationoptions_fromJSON: (a: number, b: number) => void;
  readonly jwsverificationoptions_clone: (a: number) => number;
  readonly __wbg_coredid_free: (a: number) => void;
  readonly coredid_parse: (a: number, b: number, c: number) => void;
  readonly coredid_setMethodName: (a: number, b: number, c: number, d: number) => void;
  readonly coredid_validMethodName: (a: number, b: number) => number;
  readonly coredid_setMethodId: (a: number, b: number, c: number, d: number) => void;
  readonly coredid_validMethodId: (a: number, b: number) => number;
  readonly coredid_scheme: (a: number, b: number) => void;
  readonly coredid_authority: (a: number, b: number) => void;
  readonly coredid_method: (a: number, b: number) => void;
  readonly coredid_methodId: (a: number, b: number) => void;
  readonly coredid_join: (a: number, b: number, c: number, d: number) => void;
  readonly coredid_toUrl: (a: number) => number;
  readonly coredid_intoUrl: (a: number) => number;
  readonly coredid_toString: (a: number, b: number) => void;
  readonly coredid_toJSON: (a: number, b: number) => void;
  readonly coredid_fromJSON: (a: number, b: number) => void;
  readonly coredid_clone: (a: number) => number;
  readonly __wbg_decodedjws_free: (a: number) => void;
  readonly decodedjws_claims: (a: number, b: number) => void;
  readonly decodedjws_claimsBytes: (a: number, b: number) => void;
  readonly decodedjws_protectedHeader: (a: number) => number;
  readonly decodedjws_clone: (a: number) => number;
  readonly decodedjws_toJSON: (a: number, b: number) => void;
  readonly __wbg_sdobjectdecoder_free: (a: number) => void;
  readonly sdobjectdecoder_new: () => number;
  readonly sdobjectdecoder_decode: (a: number, b: number, c: number, d: number) => void;
  readonly __wbg_jwkgenoutput_free: (a: number) => void;
  readonly jwkgenoutput_new: (a: number, b: number, c: number) => number;
  readonly jwkgenoutput_jwk: (a: number) => number;
  readonly jwkgenoutput_keyId: (a: number, b: number) => void;
  readonly jwkgenoutput_toJSON: (a: number, b: number) => void;
  readonly jwkgenoutput_fromJSON: (a: number, b: number) => void;
  ...
  readonly __wbg_keybindingjwtvalidationoptions_free: (a: number) => void;
  readonly keybindingjwtvalidationoptions_new: (a: number, b: number) => void;
  readonly keybindingjwtvalidationoptions_toJSON: (a: number, b: number) => void;
  readonly keybindingjwtvalidationoptions_fromJSON: (a: number, b: number) => void;
  readonly keybindingjwtvalidationoptions_clone: (a: number) => number;
  readonly __wbg_jwtcredentialvalidationoptions_free: (a: number) => void;
  readonly jwtcredentialvalidationoptions_new: (a: number, b: number) => void;
  readonly jwtcredentialvalidationoptions_toJSON: (a: number, b: number) => void;
  readonly jwtcredentialvalidationoptions_fromJSON: (a: number, b: number) => void;
  readonly jwtcredentialvalidationoptions_clone: (a: number) => number;
  readonly __wbg_jwtpresentationvalidationoptions_free: (a: number) => void;
  readonly jwtpresentationvalidationoptions_new: (a: number, b: number) => void;
  readonly jwtpresentationvalidationoptions_toJSON: (a: number, b: number) => void;
  readonly jwtpresentationvalidationoptions_fromJSON: (a: number, b: number) => void;
  readonly jwtpresentationvalidationoptions_clone: (a: number) => number;
  readonly __wbg_statuslist2021entry_free: (a: number) => void;
  readonly statuslist2021entry_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly statuslist2021entry_id: (a: number, b: number) => void;
  readonly statuslist2021entry_purpose: (a: number) => number;
  readonly statuslist2021entry_index: (a: number) => number;
  readonly statuslist2021entry_statusListCredential: (a: number, b: number) => void;
  readonly statuslist2021entry_toStatus: (a: number, b: number) => void;
  readonly statuslist2021entry_clone: (a: number) => number;
  readonly statuslist2021entry_toJSON: (a: number, b: number) => void;
  readonly statuslist2021entry_fromJSON: (a: number, b: number) => void;
  readonly __wbg_statuslist2021_free: (a: number) => void;
  readonly statuslist2021_clone: (a: number) => number;
  readonly statuslist2021_new: (a: number, b: number, c: number) => void;
  readonly statuslist2021_len: (a: number) => number;
  readonly statuslist2021_get: (a: number, b: number, c: number) => void;
  readonly statuslist2021_set: (a: number, b: number, c: number, d: number) => void;
  readonly statuslist2021_intoEncodedStr: (a: number, b: number) => void;
  readonly statuslist2021_fromEncodedStr: (a: number, b: number, c: number) => void;
  ...
  readonly didurl_fromJSON: (a: number, b: number) => void;
  readonly didurl_clone: (a: number) => number;
  readonly __wbg_resolver_free: (a: number) => void;
  readonly resolver_new: (a: number, b: number) => void;
  readonly resolver_resolve: (a: number, b: number, c: number, d: number) => void;
  readonly resolver_resolveMultiple: (a: number, b: number, c: number) => void;
  readonly verifyEd25519: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly __wbg_eddsajwsverifier_free: (a: number) => void;
  readonly eddsajwsverifier_new: () => number;
  readonly eddsajwsverifier_verify: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  ...
  readonly credential_createDomainLinkageCredential: (a: number, b: number) => void;
  ...
  readonly credential_toJwtClaims: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_jwtpresentationvalidator_free: (a: number) => void;
  readonly jwtpresentationvalidator_new: (a: number) => number;
  readonly jwtpresentationvalidator_validate: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly jwtpresentationvalidator_checkStructure: (a: number, b: number) => void;
  readonly jwtpresentationvalidator_extractHolder: (a: number, b: number) => void;
  readonly __wbg_linkeddomainservice_free: (a: number) => void;
  readonly linkeddomainservice_new: (a: number, b: number) => void;
  readonly linkeddomainservice_domains: (a: number) => number;
  readonly linkeddomainservice_toService: (a: number) => number;
  readonly linkeddomainservice_fromService: (a: number, b: number) => void;
  ...
  readonly proof_constructor: (a: number, b: number, c: number, d: number) => void;
  readonly proof_type: (a: number, b: number) => void;
  readonly proof_properties: (a: number, b: number) => void;
  ...
  readonly __wbg_statuslist2021credential_free: (a: number) => void;
  readonly statuslist2021credential_new: (a: number, b: number) => void;
  readonly statuslist2021credential_id: (a: number, b: number) => void;
  readonly statuslist2021credential_setCredentialStatus: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly statuslist2021credential_purpose: (a: number) => number;
  readonly statuslist2021credential_entry: (a: number, b: number, c: number) => void;
  readonly statuslist2021credential_clone: (a: number) => number;
  readonly statuslist2021credential_fromJSON: (a: number, b: number) => void;
  readonly statuslist2021credential_toJSON: (a: number, b: number) => void;
  readonly __wbg_statuslist2021credentialbuilder_free: (a: number) => void;
  ...
  readonly statuslist2021credentialbuilder_subjectId: (a: number, b: number, c: number, d: number) => void;
  readonly statuslist2021credentialbuilder_expirationDate: (a: number, b: number) => number;
  readonly statuslist2021credentialbuilder_issuer: (a: number, b: number, c: number, d: number) => void;
  readonly statuslist2021credentialbuilder_context: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly __wbg_coredocument_free: (a: number) => void;
  readonly coredocument_new: (a: number, b: number) => void;
  readonly coredocument_id: (a: number, b: number) => void;
  readonly coredocument_setId: (a: number, b: number, c: number) => void;
  readonly coredocument_controller: (a: number, b: number) => void;
  readonly coredocument_setController: (a: number, b: number, c: number) => void;
  readonly coredocument_alsoKnownAs: (a: number, b: number) => void;
  readonly coredocument_setAlsoKnownAs: (a: number, b: number, c: number) => void;
  readonly coredocument_verificationMethod: (a: number, b: number) => void;
  readonly coredocument_authentication: (a: number, b: number) => void;
  readonly coredocument_assertionMethod: (a: number, b: number) => void;
  readonly coredocument_keyAgreement: (a: number, b: number) => void;
  readonly coredocument_capabilityDelegation: (a: number, b: number) => void;
  readonly coredocument_capabilityInvocation: (a: number, b: number) => void;
  readonly coredocument_properties: (a: number, b: number) => void;
  readonly coredocument_setPropertyUnchecked: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly coredocument_service: (a: number, b: number) => void;
  readonly coredocument_insertService: (a: number, b: number, c: number) => void;
  readonly coredocument_removeService: (a: number, b: number, c: number) => void;
  readonly coredocument_resolveService: (a: number, b: number, c: number) => void;
  readonly coredocument_methods: (a: number, b: number, c: number) => void;
  readonly coredocument_verificationRelationships: (a: number, b: number) => void;
  readonly coredocument_insertMethod: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_removeMethod: (a: number, b: number, c: number) => void;
  readonly coredocument_resolveMethod: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_attachMethodRelationship: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_detachMethodRelationship: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_verifyJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly coredocument_revokeCredentials: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_unrevokeCredentials: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_clone: (a: number, b: number) => void;
  readonly coredocument__shallowCloneInternal: (a: number) => number;
  readonly coredocument__strongCountInternal: (a: number) => number;
  readonly coredocument_toJSON: (a: number, b: number) => void;
  readonly coredocument_fromJSON: (a: number, b: number) => void;
  readonly coredocument_generateMethod: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly coredocument_purgeMethod: (a: number, b: number, c: number, d: number) => void;
  readonly coredocument_createJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly coredocument_createCredentialJwt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly coredocument_createPresentationJwt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly __wbg_iotaidentityclientext_free: (a: number) => void;
  readonly iotaidentityclientext_newDidOutput: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly iotaidentityclientext_updateDidOutput: (a: number, b: number, c: number) => void;
  readonly iotaidentityclientext_deactivateDidOutput: (a: number, b: number, c: number) => void;
  readonly iotaidentityclientext_resolveDid: (a: number, b: number, c: number) => void;
  readonly iotaidentityclientext_resolveDidOutput: (a: number, b: number, c: number) => void;
  readonly __wbg_sdobjectencoder_free: (a: number) => void;
  readonly sdobjectencoder_new: (a: number, b: number) => void;
  readonly sdobjectencoder_conceal: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly sdobjectencoder_addSdAlgProperty: (a: number) => void;
  readonly sdobjectencoder_encodeToString: (a: number, b: number) => void;
  readonly sdobjectencoder_encodeToObject: (a: number, b: number) => void;
  readonly sdobjectencoder_toJSON: (a: number, b: number) => void;
  readonly sdobjectencoder_addDecoys: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly __wbg_keybindingjwtclaims_free: (a: number) => void;
  readonly keybindingjwtclaims_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly keybindingjwtclaims_toString: (a: number, b: number) => void;
  readonly keybindingjwtclaims_iat: (a: number) => number;
  readonly keybindingjwtclaims_aud: (a: number, b: number) => void;
  readonly keybindingjwtclaims_nonce: (a: number, b: number) => void;
  readonly keybindingjwtclaims_sdHash: (a: number, b: number) => void;
  readonly keybindingjwtclaims_customProperties: (a: number, b: number) => void;
  readonly keybindingjwtclaims_keyBindingJwtHeaderTyp: (a: number) => void;
  readonly keybindingjwtclaims_toJSON: (a: number, b: number) => void;
  readonly keybindingjwtclaims_fromJSON: (a: number, b: number) => void;
  readonly keybindingjwtclaims_clone: (a: number) => number;
  readonly __wbg_verificationmethod_free: (a: number) => void;
  readonly verificationmethod_newFromJwk: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly verificationmethod_id: (a: number) => number;
  readonly verificationmethod_setId: (a: number, b: number, c: number) => void;
  ...
  readonly verificationmethod_properties: (a: number, b: number) => void;
  readonly verificationmethod_setPropertyUnchecked: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly sdobjectencoder_toString: (a: number, b: number) => void;
  readonly service_clone: (a: number) => number;
  readonly __wbg_jwtcredentialvalidator_free: (a: number) => void;
  readonly jwtcredentialvalidator_new: (a: number) => number;
  readonly jwtcredentialvalidator_validate: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly jwtcredentialvalidator_verifySignature: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly jwtcredentialvalidator_checkExpiresOnOrAfter: (a: number, b: number, c: number) => void;
  readonly jwtcredentialvalidator_checkIssuedOnOrBefore: (a: number, b: number, c: number) => void;
  readonly jwtcredentialvalidator_checkSubjectHolderRelationship: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly jwtcredentialvalidator_checkStatus: (a: number, b: number, c: number, d: number) => void;
  readonly jwtcredentialvalidator_checkStatusWithStatusList2021: (a: number, b: number, c: number, d: number) => void;
  readonly jwtcredentialvalidator_extractIssuer: (a: number, b: number) => void;
  readonly jwtcredentialvalidator_extractIssuerFromJwt: (a: number, b: number) => void;
  readonly __wbg_iotadocument_free: (a: number) => void;
  readonly iotadocument_new: (a: number, b: number, c: number) => void;
  readonly iotadocument_newWithId: (a: number) => number;
  readonly iotadocument_id: (a: number, b: number) => void;
  readonly iotadocument_controller: (a: number, b: number) => void;
  readonly iotadocument_alsoKnownAs: (a: number, b: number) => void;
  readonly iotadocument_setAlsoKnownAs: (a: number, b: number, c: number) => void;
  readonly iotadocument_properties: (a: number, b: number) => void;
  readonly iotadocument_setPropertyUnchecked: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly iotadocument_service: (a: number, b: number) => void;
  readonly iotadocument_insertService: (a: number, b: number, c: number) => void;
  readonly iotadocument_removeService: (a: number, b: number, c: number) => void;
  readonly iotadocument_resolveService: (a: number, b: number, c: number) => void;
  readonly iotadocument_methods: (a: number, b: number, c: number) => void;
  readonly iotadocument_insertMethod: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_removeMethod: (a: number, b: number, c: number) => void;
  readonly iotadocument_resolveMethod: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_attachMethodRelationship: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_detachMethodRelationship: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_verifyJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly iotadocument_pack: (a: number, b: number) => void;
  readonly iotadocument_packWithEncoding: (a: number, b: number, c: number) => void;
  readonly iotadocument_unpackFromOutput: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_unpackFromBlock: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_metadata: (a: number, b: number) => void;
  readonly iotadocument_metadataCreated: (a: number, b: number) => void;
  readonly iotadocument_setMetadataCreated: (a: number, b: number, c: number) => void;
  readonly iotadocument_metadataUpdated: (a: number, b: number) => void;
  readonly iotadocument_setMetadataUpdated: (a: number, b: number, c: number) => void;
  readonly iotadocument_metadataDeactivated: (a: number, b: number) => void;
  readonly iotadocument_setMetadataDeactivated: (a: number, b: number, c: number) => void;
  readonly iotadocument_metadataStateControllerAddress: (a: number, b: number) => void;
  readonly iotadocument_metadataGovernorAddress: (a: number, b: number) => void;
  readonly iotadocument_setMetadataPropertyUnchecked: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly iotadocument_revokeCredentials: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_unrevokeCredentials: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_clone: (a: number, b: number) => void;
  readonly iotadocument__shallowCloneInternal: (a: number) => number;
  readonly iotadocument__strongCountInternal: (a: number) => number;
  readonly iotadocument_toJSON: (a: number, b: number) => void;
  readonly iotadocument_fromJSON: (a: number, b: number) => void;
  readonly iotadocument_toCoreDocument: (a: number, b: number) => void;
  readonly iotadocument_generateMethod: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly iotadocument_purgeMethod: (a: number, b: number, c: number, d: number) => void;
  readonly iotadocument_createJwt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly iotadocument_createJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly iotadocument_createCredentialJwt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly iotadocument_createPresentationJwt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly __wbg_iotadocumentmetadata_free: (a: number) => void;
  ...
  readonly iotadocumentmetadata_stateControllerAddress: (a: number, b: number) => void;
  readonly iotadocumentmetadata_governorAddress: (a: number, b: number) => void;
  readonly iotadocumentmetadata_properties: (a: number, b: number) => void;
  readonly iotadocumentmetadata_toJSON: (a: number, b: number) => void;
  readonly iotadocumentmetadata_fromJSON: (a: number, b: number) => void;
  readonly iotadocumentmetadata_clone: (a: number) => number;
  readonly __wbg_jwtpresentationoptions_free: (a: number) => void;
  readonly jwtpresentationoptions_new: (a: number, b: number) => void;
  readonly jwtpresentationoptions_toJSON: (a: number, b: number) => void;
  readonly jwtpresentationoptions_fromJSON: (a: number, b: number) => void;
  readonly jwtpresentationoptions_clone: (a: number) => number;
  readonly __wbg_jwssignatureoptions_free: (a: number) => void;
  readonly jwssignatureoptions_new: (a: number, b: number) => void;
  ...
  readonly jwssignatureoptions_serUrl: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly jwssignatureoptions_setCustomHeaderParameters: (a: number, b: number, c: number) => void;
  readonly jwssignatureoptions_toJSON: (a: number, b: number) => void;
  readonly jwssignatureoptions_fromJSON: (a: number, b: number) => void;
  readonly jwssignatureoptions_clone: (a: number) => number;
  readonly __wbg_iotadid_free: (a: number) => void;
  readonly iotadid_static_default_network: (a: number) => void;
  readonly iotadid_new: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly iotadid_fromAliasId: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly iotadid_placeholder: (a: number, b: number, c: number) => void;
  readonly iotadid_parse: (a: number, b: number, c: number) => void;
  readonly iotadid_network: (a: number, b: number) => void;
  readonly iotadid_tag: (a: number, b: number) => void;
  readonly iotadid_toCoreDid: (a: number) => number;
  readonly iotadid_scheme: (a: number, b: number) => void;
  readonly iotadid_authority: (a: number, b: number) => void;
  readonly iotadid_method: (a: number, b: number) => void;
  readonly iotadid_methodId: (a: number, b: number) => void;
  readonly iotadid_join: (a: number, b: number, c: number, d: number) => void;
  readonly iotadid_toUrl: (a: number) => number;
  readonly iotadid_toAliasId: (a: number, b: number) => void;
  readonly iotadid_intoUrl: (a: number) => number;
  readonly iotadid_toString: (a: number, b: number) => void;
  readonly iotadid_toJSON: (a: number, b: number) => void;
  readonly iotadid_fromJSON: (a: number, b: number) => void;
  readonly iotadid_clone: (a: number) => number;
  readonly __wbg_disclosure_free: (a: number) => void;
  readonly disclosure_new: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly disclosure_parse: (a: number, b: number, c: number) => void;
  readonly disclosure_disclosure: (a: number, b: number) => void;
  readonly disclosure_salt: (a: number, b: number) => void;
  readonly disclosure_claimName: (a: number, b: number) => void;
  readonly disclosure_claimValue: (a: number, b: number) => void;
  readonly disclosure_toJSON: (a: number, b: number) => void;
  readonly disclosure_fromJSON: (a: number, b: number) => void;
  ...
  readonly iotadid_static_method: (a: number) => void;
  readonly disclosure_toEncodedString: (a: number, b: number) => void;
  readonly disclosure_toString: (a: number, b: number) => void;
  readonly __wbindgen_malloc: (a: number, b: number) => number;
  readonly __wbindgen_realloc: (a: number, b: number, c: number, d: number) => number;
  readonly __wbindgen_export_2: WebAssembly.Table;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h6b756352abf9a872: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h4225c528b42ae029: (a: number, b: number, c: number, d: number) => void;
